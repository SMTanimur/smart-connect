  ...
  const RightbarHome = () => {
    return (
      <>
        ...
        /> */}
        <h4 className="mt-8 rightbar__title">Online Friends</h4>
        ...
        {!isEdit ? (
          ...
          <div className="rightbar__edit-info">
            ...
            {/* <div className="rightbar__control">
              ...
              <input
                className="w-full px-3 py-2 mt-1 transition duration-200 border border-gray-300 rounded outline-none bg-gray-50 focus:bg-white hover:bg-white"
                type="text"
                name="city"
                placeholder={'City ...'}
                id="city"
