...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await axios.post('/auth/register', formState).then(() => {
        navigate('/login');
        setErrors({});
      });
    } catch (error: any) {
  ...
  return (
    <div className='flex bg-white w-full justify-center items-center h-screen'>
      <div className='flex flex-col justify-center h-screen pl-6'>
        <div className='w-[600px]'>
          ...
          <form onSubmit={handleSubmit}>
            <div className='flex items-center mb-2'>
              <input
                type='checkbox'
                className='mr-1 border border-gray-100 cursor-pointer'
                name='agreement'
